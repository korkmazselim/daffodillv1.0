...
namespace Daffodill.Infrastructure.Migrations
{
    ...
    partial class DaffodillDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Daffodill.Domain.WordsExamples", b =>
                {
                    ...
                    b.Property<int>("WordsMeaningsId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WordsMeaningsId");

                    b.ToTable("WordsExamples");
                });

            modelBuilder.Entity("Daffodill.Domain.WordsMeanings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Daffodill.Domain.WordsExamples", b =>
                {
                    b.HasOne("Daffodill.Domain.WordsMeanings", "WordsMeanings")
                        .WithMany("WordsExamples")
                        .HasForeignKey("WordsMeaningsId")
